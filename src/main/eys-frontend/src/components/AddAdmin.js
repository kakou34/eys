...
const AddAdmin = (props) => {
    ...
    const onChangeTurkishID = (e) => {
        const turkishID = e.target.value;
        setTurkishID(turkishID);
    };
    ...
    const handleRegister = (e) => {
        ...
        if (checkBtn.current.context._errors.length === 0) {
            AuthService.addAdmin(username, email, password, firstname, lastname, turkishID).then(
                (response) => {
